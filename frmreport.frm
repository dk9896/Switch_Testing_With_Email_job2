...
If reporttype = 1 Then
   ...
   End If
    ...
    With VSFReport
      ...
      .TextMatrix(Row, 15) = Rs("BMResult")
      .TextMatrix(Row, 16) = Rs("BM1Cur")
      .TextMatrix(Row, 17) = Rs("BM1Volt")
      .TextMatrix(Row, 18) = Rs("BM2Cur")
      .TextMatrix(Row, 19) = Rs("BM2Volt")
      .TextMatrix(Row, 20) = Rs("HMResult")
      .TextMatrix(Row, 21) = Rs("HM1Cur")
      .TextMatrix(Row, 22) = Rs("HM1Volt")
      .TextMatrix(Row, 23) = Rs("LEMResult")
      .TextMatrix(Row, 24) = Rs("LEM1Cur")
      .TextMatrix(Row, 25) = Rs("LEM1Volt")
      .TextMatrix(Row, 26) = Rs("EKSResult")
      .TextMatrix(Row, 27) = Rs("EKS1Cur")
      .TextMatrix(Row, 28) = Rs("EKS1Volt")
      .TextMatrix(Row, 29) = Rs("EKS2Cur")
      .TextMatrix(Row, 30) = Rs("EKS2Volt")
...
With VSFReport
    ...
    .TextMatrix(0, 15) = "Blinker Module"
    .TextMatrix(0, 16) = "Blinker Module"
    .TextMatrix(0, 17) = "Blinker Module"
    .TextMatrix(0, 18) = "Blinker Module"
    .TextMatrix(0, 19) = "Blinker Module"
    .TextMatrix(1, 15) = "Result"
    .TextMatrix(1, 16) = "Left Current"
    .TextMatrix(1, 17) = "Left Voltage"
    .TextMatrix(1, 18) = "Right Current"
    .TextMatrix(1, 19) = "Right Voltage"
    
    .TextMatrix(0, 20) = "Horn Module"
    .TextMatrix(0, 21) = "Horn Module"
    .TextMatrix(0, 22) = "Horn Module"
    .TextMatrix(1, 20) = "Result"
    .TextMatrix(1, 21) = "On Current"
    .TextMatrix(1, 22) = "On Voltage"
    
    .TextMatrix(0, 23) = "Lever Module"
    .TextMatrix(0, 24) = "Lever Module"
    .TextMatrix(0, 25) = "Lever Module"
    .TextMatrix(1, 23) = "Result"
    .TextMatrix(1, 24) = "ON Current"
    .TextMatrix(1, 25) = "ON Voltage"
    
    .TextMatrix(0, 26) = "Engine Kill/Start Module"
    .TextMatrix(0, 27) = "Engine Kill/Start Module"
    .TextMatrix(0, 28) = "Engine Kill/Start Module"
    .TextMatrix(0, 29) = "Engine Kill/Start Module"
    .TextMatrix(0, 30) = "Engine Kill/Start Module"
    .TextMatrix(1, 26) = "Result"
    .TextMatrix(1, 27) = "ON Current"
    .TextMatrix(1, 28) = "ON Voltage"
    .TextMatrix(1, 29) = "Start Current"
    .TextMatrix(1, 30) = "Start Voltage"
